 ...
 * @author tulio
 */
public class FormEditora extends java.awt.Dialog{
    DAOEditora objDAOEditora = new DAOEditora();

    /** Creates new form FormCidade */
    public FormEditora(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        atualizaTabela();
        trataEdicao(false);
    ...
    public void atualizaTabela(){
        listEditora.clear();
        listEditora.addAll(objDAOEditora.getLista());
        int linha = listEditora.size()-1;
        if(linha>=0){
            tblEditora.setRowSelectionInterval(linha, linha);
      tblEditora.scrollRectToVisible(tblEditora.getCellRect(linha,linha,true));
        }
    }
    ...
    private void trataEdicao(boolean editando){
        ...
        tblEditora.setEnabled(editando);
    ...
    private void initComponents() {
        ...
        listEditora = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Editora>())
        ;
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listEditora, tblEditora);
        ...
        jTableBinding.bind();org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listEditora, org.jdesktop.beansbinding.ObjectProperty.create(), tblEditora, org.jdesktop.beansbinding.BeanProperty.create("selectedElement"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblEditora, org.jdesktop.beansbinding.ELProperty.create("${selectedElement}"), txtCodigo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblEditora, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nome}"), txtNome, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnPrimeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrimeiroActionPerformed
        ...
        tblEditora.setRowSelectionInterval(0, 0);
        tblEditora.scrollRectToVisible(tblEditora.getCellRect(0, 0, true));
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        // TODO add your handling code here:
        trataEdicao(true);
        listEditora.add((Editora)new Editora());// cria um objeto e uma linha na tabela
        int linha = listEditora.size()-1;
        tblEditora.setRowSelectionInterval(linha, linha);// seleciona a linha
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        Editora objEditora = listEditora.get(linhaSelecionada);
        objDAOEditora.salvar(objEditora);
        atualizaTabela();
        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if(opcao==0){
          int linhaSelecionada = tblEditora.getSelectedRow();
          Editora objEditora = listEditora.get(linhaSelecionada);
          objDAOEditora.remover(objEditora);
          atualizaTabela();
          trataEdicao(false);
        }
    ...
    private void btnAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnteriorActionPerformed
        ...
        tblEditora.setRowSelectionInterval(linha, linha);
        tblEditora.scrollRectToVisible(tblEditora.getCellRect(linha, 0, true));
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        // TODO add your handling code here:
       int linha = tblEditora.getSelectedRow();
        if((linha+1)<=(tblEditora.getRowCount())-1){
            linha++;
        }
        tblEditora.setRowSelectionInterval(linha, linha);
        tblEditora.scrollRectToVisible(tblEditora.getCellRect(linha, 0, true));
    ...
    private void btnUltimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUltimoActionPerformed
        // TODO add your handling code here:
        int linha = tblEditora.getRowCount()-1;
        tblEditora.setRowSelectionInterval(linha, linha);
        tblEditora.scrollRectToVisible(tblEditora.getCellRect(linha, 0, true));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormEditora dialog = new FormEditora(new javax.swing.JFrame(), true);
    ...
    private java.util.List<Editora> listEditora;
